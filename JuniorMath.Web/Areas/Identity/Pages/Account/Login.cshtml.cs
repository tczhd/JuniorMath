...
namespace JuniorMath.Web.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class LoginModel : PageModel
    {
        ...
        public  SiteSettingsOptions SiteSettingsOptions { get; }

        public LoginModel(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager
            , ILogger<LoginModel> logger, UserHandler userHandler, IUserService userService, IOptions<SiteSettingsOptions> siteSettingsOptions)
        {
            ...
            SiteSettingsOptions = siteSettingsOptions.Value;
        }
