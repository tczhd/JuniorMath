...
$(document).ready(function () {
    ...
    if ($("#PrimaryMemberHidden").val() == "False"){
        ...
        if (isvalid) {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (result.success) {
                        modalBody.html(processName + " new patient success. ");
                        ...
                        modalBody.html(processName + " new patient failed. Error: " + result.message);
                    }
