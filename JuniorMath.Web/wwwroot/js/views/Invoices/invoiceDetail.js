$(document).ready(function () {
    ...
    JuniorMath.InvoiceDetail.Init();

});


JuniorMath.InvoiceDetail = {
    ...
    ShowPaymentModal: function () {
        ...
        var button = JuniorMath.getModalFooterButton('apply-payment-btn', 'Apply Payment');
           ...
           // modalBody.html('');
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    modalFooter.html('');
                    if (result.approved) {
                        var paymentMessage = "<h2>" + result.message + "</h2> <h3>Amount paid: " + result.amount_paid_total.toFixed(2) + "</h3>";
                        paymentMessage += "<h3>AuthCode: " + result.auth_code+ "</h3>";
                        paymentMessage += "<h3>Credit Card: ************" + result.card_last4 + "</h3>";
                        ...
                        modalBody.html(result.message);
                        var tryAgainBbutton = JuniorMath.getModalFooterButton('try-again-btn', 'Try Again');
