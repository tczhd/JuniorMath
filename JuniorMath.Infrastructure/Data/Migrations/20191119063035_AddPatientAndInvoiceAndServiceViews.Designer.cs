...
namespace JuniorMath.Infrastructure.Data.Migrations
{
    ...
    [Migration("20191119063035_AddPatientAndInvoiceAndServiceViews")]
    partial class AddPatientAndInvoiceAndServiceViews
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JuniorMath.ApplicationCore.Entities.IndustryCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("JuniorMath.ApplicationCore.Entities.InvoiceAggregate.InvoicePayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("JuniorMath.ApplicationCore.Entities.PatientAggregate.PatientCardOnFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("JuniorMath.ApplicationCore.Entities.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("JuniorMath.ApplicationCore.Entities.ServiceGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("JuniorMath.ApplicationCore.Entities.InvoiceAggregate.InvoicePayment", b =>
                {
                    ...
                    b.HasOne("JuniorMath.ApplicationCore.Entities.Payment", "Payment")
                        .WithMany("InvoicePayment")
            ...
            modelBuilder.Entity("JuniorMath.ApplicationCore.Entities.Item", b =>
                {
                    ...
                    b.HasOne("JuniorMath.ApplicationCore.Entities.IndustryCode", "IndustryCode")
                        .WithMany("Items")
                        .HasForeignKey("IndustryCodeId")
                        .HasConstraintName("FK_Item_IndustryCode");

                    b.HasOne("JuniorMath.ApplicationCore.Entities.ServiceGroup", "ServiceGroup")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("JuniorMath.ApplicationCore.Entities.PatientAggregate.PatientCardOnFile", b =>
                {
                    ...
                    b.HasOne("JuniorMath.ApplicationCore.Entities.UserAggregate.SiteUser", "SiteUser")
