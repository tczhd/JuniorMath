...
namespace JuniorMath.Infrastructure.Data.Repository.Base
{
    /// <summary>
    ...
    {
        protected readonly JuniorMathContext _dbContext;

        public EfRepository(JuniorMathContext dbContext)
        {
